...
export default function() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8081/v2/order/all')
                    ...
                    <TableBody>
                        {
                            Array.from(Array(orders.length)).map((_, index) => (
                                <TableRow>
                                    <TableCell align="center">{orders[index]?.user?.userName}</TableCell>
                                    <TableCell align="center">{orders[index]?.user?.firstName}</TableCell>
                                    <TableCell align="center">{orders[index]?.user?.lastName}</TableCell>
